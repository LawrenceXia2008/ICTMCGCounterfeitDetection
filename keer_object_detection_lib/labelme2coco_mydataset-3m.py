...
class Lableme2CoCo:
    ...
    def to_coco(self, json_path_list,resize_scale):
        ...
        for json_path in json_path_list:
            ...
            annotation_outer = self._annotation(shape,img_scale,resize_scale)
    ...
    def to_coco_FlipTransform(self, json_path_list,resize_scale):
        ...
        for json_path in json_path_list:
            ...
            anno=self._annotation(shape, img_scale,resize_scale)
            ...
            self.images.append(image)
            anno_r90=self._annotation(shape, img_scale,resize_scale,FlipTransform=90)
            self.annotations.append(anno_r90)
            self.ann_id += 1
            ...
            self.images.append(image)
            anno_r180=self._annotation(shape, img_scale, resize_scale, FlipTransform=180)
            self.annotations.append(anno_r180)
            self.ann_id += 1
            ...
            self.images.append(image)
            anno_r270=self._annotation(shape, img_scale, resize_scale, FlipTransform=270)
            self.annotations.append(anno_r270)
            self.ann_id += 1
    ...
    def _annotation(self, shape, img_scale, resize_scale, FlipTransform=None):
        ...
        annotation['category_id'] = int(classname_to_id['3m'])
...
if __name__ == '__main__':
    ...
    src_gt_path='D:/Myfile_ms/Research/CVPRJ/mask0126/HUXIFA/HUXIFA_OD/newtext0308/gt'
    src_image_path='D:/Myfile_ms/Research/CVPRJ/mask0126/HUXIFA/HUXIFA_OD/newtext0308/image'

    saved_coco_path = "D:/Myfile_ms/Research/CVPRJ/mask0126/HUXIFA/HUXIFA_OD/"
    # 创建文件
